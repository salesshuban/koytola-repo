...
class Company(SeoModel, PublishableModel):
    ...
    slug = models.TextField(unique=True, max_length=2550, null=True, blank=True)
    name = models.TextField(max_length=2500, unique=True, null=True, blank=True)
    ...
    logo = VersatileImageField(upload_to=upload_path_handler, blank=True, null=True)
    ...
    content_plaintext = models.TextField(max_length=65500, blank=True, null=True)
...
class Contact(models.Model):
    ...
    def __str__(self):
        return self.name + ' - ' + self.email + ' from ' + self.company.name + ' at ' + \
