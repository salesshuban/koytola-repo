...
class ContactAdmin(admin.ModelAdmin):
    list_display = [
        "id", "company", "name", "email", "submission_date", "subject",
        "contact", "type", "status"
    ]
    search_fields = ["company", "name", "email", "subject", "contact"]
    list_filter = ["submission_date", "company", "type", "status", "country"]
    list_per_page = 100
    actions = [download_csv]
...
class CertificateTypeAdmin(admin.ModelAdmin):
    list_display = ["id", "name", "type", "description", "is_active", "creation_date", "update_date"]
    search_fields = ["name", ]
    list_filter = ["name", "is_active"]
    list_per_page = 100
    actions = [download_csv]
...
class RoetterAdmin(admin.ModelAdmin):
    ...
    search_fields = ["name", "category__id", "category__name", "type"]
