...
class BlogInput(graphene.InputObjectType):
    category_id = graphene.List(graphene.ID, description="Blog category ID.")
...
class BlogCreate(ModelMutation):
    ...
    def perform_mutation(cls, root, info, **data):
        ...
        instance.category.add(*cleaned_input['category_id'])
...
class BlogUpdate(ModelMutation):
    ...
    def clean_input(cls, info, instance, data):
        cleaned_input = super().clean_input(info, instance, data)
        if 'image' not in cleaned_input or not cleaned_input['image']:
        ...
        instance.category.set(cleaned_input['category_id'])
        return cleaned_input
