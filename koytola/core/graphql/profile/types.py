...
from ..core.types.certificate_type import Certificate, CertificateType
...
class Company(CountableDjangoObjectType):
    ...
    def resolve_brands(root: models.Company, info, size=None, **_kwargs):
        print(root.address.country.code, root.address.country.flag)
        if root.brands:
    ...
    @staticmethod
    def resolve_images(root: models.Company, info, size=None, **_kwargs):
        if root.images:
