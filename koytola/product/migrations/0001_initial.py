    ...
    operations = [
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('quantity_unit', models.CharField(blank='item', choices=[('centimeter', 'Centi-Meter unit'), ('centimeter-square', 'Centi-Meter Square Unit'), ('centimeter-cube', 'Centi-Meter Cube Unit'), ('gallon', 'Gallon unit'), ('gram', 'Gram unit'), ('item', 'Item unit'), ('kilogram', 'Kilo-Gram unit'), ('lbm', 'Pound unit'), ('liter', 'Liter unit'), ('milligram', 'Milli-Gram unit'), ('millimeter', 'Milli-Meter unit'), ('millimeter-square', 'Milli-Meter Square unit'), ('millimeter-cube', 'Milli-Meter Cube unit'), ('meter', 'Meter unit'), ('meter-square', 'Meter Square Unit'), ('meter-cube', 'Meter Cube unit'), ('ounce', 'Ounce unit'), ('ton', 'Ton unit')], max_length=32, null=True)),
                ('currency', models.CharField(default='USD', max_length=4)),
                ('price', models.FloatField(default=0.0)),
                ('container_number', models.CharField(blank=True, max_length=250, null=True)),
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('delivery_time_option', models.CharField(blank=True, choices=[('ready to ship', 'Ready To Ship'), ('needs time to ship', 'Needs Time To Ship')], max_length=32, null=True)),
        ...
        migrations.CreateModel(
            ...
            fields=[
                ('id', models.AutoField(auto_created=True, primary_key=True, serialize=False, verbose_name='ID')),
                ('image', versatileimagefield.fields.VersatileImageField(blank=True, null=True, upload_to='products/port/')),
                ('ppoi', versatileimagefield.fields.PPOIField(default='0.5x0.5', editable=False, max_length=20)),
                ('video', versatileimagefield.fields.VersatileImageField(blank=True, null=True, upload_to='products/port/')),
                ('alt_text', models.CharField(blank=True, max_length=128)),
                ('is_active', models.BooleanField(default=True)),
                ('created_at', models.DateTimeField(auto_now_add=True)),
                ('updated_at', models.DateTimeField(auto_now_add=True)),
